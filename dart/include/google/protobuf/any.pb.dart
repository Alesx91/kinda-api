...
//  source: include/google/protobuf/any.proto
//
// @dart = 2.3
...
class Any extends $pb.GeneratedMessage with $mixin.AnyMixin {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Any', package: const $pb.PackageName('google.protobuf'), createEmptyInstance: create, toProto3Json: $mixin.AnyMixin.toProto3JsonHelper, fromProto3Json: $mixin.AnyMixin.fromProto3JsonHelper)
    ..aOS(1, 'typeUrl')
